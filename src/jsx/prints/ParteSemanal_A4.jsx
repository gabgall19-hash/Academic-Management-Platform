...
export const handlePrintParteSemanal = (data, course, scheduleData) => {
  ...
  win.document.write(`
    <html>
      <head>
        <title>Parte Semanal - ${course.ano} ${course.division}</title>
        <style>
      ...
      <body>
        <div class="no-print-toolbar">
          <button class="btn-print" onclick="window.print()">🖨️ IMPRIMIR PARTE SEMANAL</button>
        </div>
